<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="picspage.aspx.cs" Inherits="picspage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="style1">
        <tr>
            ...
            <td class="style7">
                <asp:Label ID="Label13" runat="server" Text="Select Your Brand :" 
                    Font-Size="X-Large"></asp:Label>
            </td>
            <td class="style7">
                <asp:DropDownList ID="DropDownList1" runat="server">
                    <asp:ListItem>Select Your Brand</asp:ListItem>
        ...
        <tr>
            ...
            <td class="style8">
                <asp:ImageButton ID="ImageButton23" runat="server" 
                    onclick="ImageButton23_Click" Height="81px" 
                    ImageUrl="~/Buttons2/submit.png" Width="216px" />
            </td>
