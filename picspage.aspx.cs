...
public partial class picspage : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Label31.Text = Session["oid"].ToString();
    ...
    protected void ImageButton23_Click(object sender, ImageClickEventArgs e)
    {
        ...
        cmd.Parameters.Add("@bn", SqlDbType.NVarChar).Value = DropDownList1.Text;
        cmd.Parameters.Add("@cn", SqlDbType.NVarChar).Value = Label14.Text;
